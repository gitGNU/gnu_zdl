        ...
        callback: function (str) {
            if (isJsonString(str)) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    output += "<div class='background-element'>" +
                    "<div class='label-element'>Downloader:</div>" +
                    "<div class='element'><span>" + data[i].downloader + "</span></div></div>";

                    output += "<div class='background-element'>" +
                    "<div class='label-element'>Link:</div>" +
                    "<div class='element'><span>" + data[i].link + "</span></div></div>";

                    output += "<div class='background-element'>" +
                    "<div class='label-element'>Path:</div>" +
                    "<div class='element'><span>" + data[i].path + "</span><button class='btn' id='link-to-path-" + i + "'>Gestisci</button></div></div>";

                    output += "<div class='background-element'>" +
                    "<div class='label-element'>File:</div>" +
                    "<div class='element'><span>" + data[i].file + "</span><button class='btn' id='link-add-playlist-" + i + "'>Aggiungi alla playlist</button></div></div>";

                    output += "<div class='background-element'>" +
                    "<div class='label-element'>Length:</div>" +
                    "<div class='element'><span>" + (data[i].length / 1024 / 1024).toFixed(2) +  "M</span></div></div>";

                    if (data[i].downloader.match(/^(RTMPDump|cURL)$/)) {
                        output += "<div class='background-element'>" +
                        "<div class='label-element'>Streamer:</div>" +
                        "<div class='element'><span>" + data[i].streamer + "</span></div></div>";
                        output += "<div class='background-element'>" +
                        "<div class='label-element'>Playpath:</div>" +
                        "<div class='element'><span>" + data[i].playpath + "</span></div></div>";
                    } else {
                        output += "<div class='background-element'>" +
                        "<div class='label-element'>Url:</div>" +
                        "<div class='element'><span>" + toHtmlEntities(data[i].url) + "</span></div></div>";
                    }
